...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function(){
      var caracteresSeparados = this.split('');
      // caracteresSeparados es un array.
      var caracteresReversa = [];
      for (let i = 0 ; i< caracteresSeparados.length ; i++) {
         caracteresReversa.unshift(caracteresSeparados[i]);
      }
      var palabraRevertida = caracteresReversa.join('');
